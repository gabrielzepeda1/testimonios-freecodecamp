...
function objTestimonio(nombre, pais, imagen, alt, cargo, empresa, testimonio) { 
    this.nombre = nombre;
    this.pais = pais;
    this.imagen = imagen;
    this.alt = alt;
